...
var scrollVis = function () {
  ...
  var setupVis = function (wordData, fillerCounts, histData) {
    ...
    g.selectAll('.count-title')
      .attr('opacity', 0);
    /*
    var linedata = [{x:0,y:1},{X:3,y:4},{x:0,y:2},{x:3,y:6},{x:8,y:10}]
    var lines = g.selectAll('.openvis-title').data(linedata)
    var linesE = lines.enter().append('path')
